...
const logs = [
  { action: "Certificate verified", user: "student_0x3f..a2", time: "2 min ago", status: "success" },
  { action: "Attendance logged", user: "student_0x7b..c1", time: "5 min ago", status: "success" },
              ...
              >
                ...
                <div className="text-right">
                  <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${
                    log.status === "success" ? "bg-accent/10 text-accent" : "bg-primary/10 text-primary"
                  }`}>
                    {log.status}
                  </span>
